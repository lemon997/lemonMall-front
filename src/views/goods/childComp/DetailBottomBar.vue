<template>
  <van-action-bar>
    ...
    <van-action-bar-button
      type="warning"
      text="加入购物车"
      @click="addCartOnClick(info.id)"
    />
    <van-action-bar-button
      type="danger"
      text="立即购买"
      @click="buyOnClick(info.id)"
    />
  </van-action-bar>
</template>
...
import { addCart,changeCheckedStatus } from "network/cart";
